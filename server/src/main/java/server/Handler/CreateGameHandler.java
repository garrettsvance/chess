...
public class CreateGameHandler implements Route {
    ...
    public Object handle(Request sparkRequest, Response response) throws Exception {
        ...
        try {
            CreateGameService.CreateGameRequest request = (CreateGameService.CreateGameRequest) gson.fromJson(sparkRequest.body(), CreateGameService.CreateGameRequest.class);
